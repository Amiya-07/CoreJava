...
public class Bank 
{
	...
	{
		return "bank Name = "+bankName+", CustomerName = "+bankCustomerName+", bank Address = "+bankAddress+", IFSCCode = "+bankIFSCCode+", Account Number = "+customerAccountNumber+", current Balance = "+currentBalance;
	}
...
/*
 *  BLC class named as Bank is given in which you need to write the code for performing 
